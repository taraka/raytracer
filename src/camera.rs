...
mod tests {
    ...
    fn ray_through_corner() {
        ...
        assert_eq!(r, Ray::new(point(0.0, 0.0, 0.0), vector(0.66519, 0.33259, -0.66851)));
    }
    ...
    fn ray_with_transform() {
        ...
        assert_eq!(r, Ray::new(point(0.0, 2.0, -5.0), vector((2.0_f64).sqrt() / 2.0, 0.0, -((2.0_f64).sqrt() / 2.0))));
    }
    ...
    fn render_the_world() {
        ...
        c.transform = Matrix4::view_transform(point(0.0, 0.0, -5.0), point(0.0, 0.0, 0.0), vector(0.0, 1.0, 0.0));
